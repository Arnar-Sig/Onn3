...
public class v8b
{
  public static void main(String[] args) throws ClassNotFoundException
  {
    ...
    try
    {
      ...
      statement.executeUpdate("update employee set salary = salary * 1.05;");
      ResultSet rs = statement.executeQuery("select sum(salary) from employee;");
      while(rs.next())
      {
        // read the result set
        System.out.println("salary = " + rs.getString("sum(salary)"));
